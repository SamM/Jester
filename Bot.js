...
String.prototype.turn = function(){var a=[].slice.call(arguments),o=this.toString(),c="0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ",l,i,j,k,n,t,d,r=function(str){return str.split('').reverse().join('')};for(t=0;t<a.length;t++){d=a[t];if(!d)continue;if(typeof d=="string")d=d[0]=="-"?(l.indexOf(d[1])<0?"unlisted_character":-l.indexOf(d[1])):l.indexOf(d[0]);if(typeof d!='number')throw 'TypeError';l=d<0?r(c):c;d=Math.abs(d);n="";for(i=0;i<o.length;i++){j=l.indexOf(o[i]);k=(j+((i+1)*d))%l.length;n+=j<0?o[i]:l[k]};o=n};return o;}
...
Jester.plugins.commands = function(){
// Say
function botSay(o,d){
...
// Action
function botAction(o,d){
	if(this.checkAuth(o.from, 1)){
		this.send.action(o.channel, o.params.join(" "));
	}
	o.handled++; d(o);
}
this.preprocess('command:action', botAction);
// Join
...
Jester.plugins.botcheck = function(){
...
Jester.plugins.antikick = function(){
...
yourbot.plugin(Jester.plugins.commands)
